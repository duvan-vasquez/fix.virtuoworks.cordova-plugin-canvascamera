...
## Working Demo
Having trouble using CanvasCamera Plugin ? [Check our working demo here](https://github.com/duvan1995/fix.virtuoworks.cordova-plugin-canvascamera).
...
```bash
cordova plugin add https://github.com/duvan1995/fix.virtuoworks.cordova-plugin-canvascamera.git && cordova prepare
```
...
```bash
cordova plugin remove fix.virtuoworks.cordova-plugin-canvascamera
```
